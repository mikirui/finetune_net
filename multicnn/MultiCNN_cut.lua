...
googlenet_path = '/home/qianlima/torch-test/raw_googlenet_cut.t7'

local layer, parent = torch.class('nn.MultiCNN_cut', 'nn.Module')
...
function layer:build_model()
	...
	self.linear = nn.Linear(832*self.comb, 2048)
	if(self.comb == 3) then
